...
let GitsPage = class GitsPage {
    constructor(authService, utilityService, router) {
...
GitsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
